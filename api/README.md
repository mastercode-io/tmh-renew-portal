...
| `GET` | `/api/renewal/payment-link?token=deal_tok_123` | Requests a hosted payment URL using the encrypted deal token from order response. | `CRM_REQUIRED_APIS.XeroPaymentLink` |
